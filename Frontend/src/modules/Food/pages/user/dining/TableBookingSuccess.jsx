...
export default function TableBookingSuccess() {
    ...
    return (
        <AnimatedPage className="bg-white min-h-screen flex flex-col items-center justify-center p-6 pb-24">
            ...
            >
                <CheckCircle2 className="w-12 h-12 text-[#DC021B]" />
            </motion.div>
            ...
            >
                ...
                <div className="pt-2">
                    <span className="bg-red-50 text-[#DC021B] px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest border border-[#DC021B]/20">
