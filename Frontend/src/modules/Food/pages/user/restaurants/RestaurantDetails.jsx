    ...
    >
              ...
              <div className="flex items-center gap-2 flex-1 max-w-md">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2.5 rounded-full border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-[#1a1a1a] text-sm dark:text-white focus:outline-none focus:ring-2 focus:ring-[#DC021B] focus:border-transparent"
                    autoFocus
                  />
                  {searchQuery && (
        ...
        <div className="max-w-7xl mx-auto mt-4 bg-white dark:bg-[#1a1a1a] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 dark:border-gray-800 p-4 relative overflow-hidden">
           <div className="flex items-center justify-between gap-4">
             <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-red-50 flex items-center justify-center flex-shrink-0">
                  <Percent className="h-6 w-6 text-[#DC021B]" />
                </div>
                <div>
           ...
           <div className="flex items-center gap-1 mt-3 px-1">
              {highlightOffers.slice(0, 2).map((_, i) => (
                <div 
                  key={i} 
                  className={`h-1.5 w-1.5 rounded-full transition-colors ${i === highlightIndex % 2 ? 'bg-[#DC021B]' : 'bg-gray-200'}`} 
                />
              ))}
           </div>
        </div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 whitespace-nowrap rounded-full border px-3 py-1.5 text-sm font-semibold transition-colors ${
                      selectedMenuCategory === "all"
                        ? "border-[#DC021B] bg-red-50 text-[#DC021B]"
                      ...
                      {sectionItems.map((item) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex gap-4 p-4 border-b border-gray-100 last:border-none relative cursor-pointer transition-all duration-300 ${highlightedDishId === item.id ? "bg-red-50 ring-2 ring-[#DC021B] ring-inset dark:bg-orange-950/20" : ""}`}
                              ...
                              {isRecommendedItem(item) && (
                                <div className="flex items-center gap-2 mt-1">
                                  <div className="h-1.5 w-16 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                    <div className="h-full bg-[#DC021B] w-3/4"></div>
                                  </div>
                              ...
                              {quantity > 0 ? (
                                <motion.div
                                  ...
                                  className={`absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white border font-bold px-4 py-1.5 rounded-lg shadow-md flex items-center gap-1 ${shouldShowGrayscale
                                    ...
                                    : 'border-[#DC021B] text-[#DC021B] hover:bg-red-50'
                                    }`}
                                >
                                  <button
                                    onClick={(e) => {
                                    ...
                                    className={shouldShowGrayscale ? 'text-gray-400 cursor-not-allowed' : 'text-[#DC021B] hover:text-[#B30216]'}
                                  >
                                    <Minus size={14} />
                                  </button>
      ...
      {!showFilterSheet && !showMenuSheet && !showMenuOptionsSheet && (
        <div className="sticky dark:bg-[#1a1a1a] bottom-4 flex justify-end px-4 z-50 mt-auto">
          <Button
            className="bg-[#1a1a1a] dark:bg-[#DC021B] hover:bg-black dark:hover:bg-[#B30216] text-white flex items-center gap-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 dark:border-[#DC021B]/20 px-6 py-6 rounded-full font-bold transform transition-all duration-300 hover:scale-110 active:scale-95 group"
            size="lg"
            onClick={() => setShowMenuSheet(true)}
          >
            <Utensils className="h-5 w-5 text-[#DC021B] dark:text-white group-hover:rotate-12 transition-transform" />
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4 bg-white dark:bg-[#1a1a1a]">
                    <Button
                      className="w-full bg-[#1a1a1a] dark:bg-[#DC021B] hover:bg-[#DC021B] dark:hover:bg-[#B30216] text-white border-0 flex items-center justify-center gap-2 py-6 rounded-xl font-bold transition-all shadow-lg"
                      onClick={() => setShowMenuSheet(false)}
                    >
                      <X className="h-5 w-5" />
                      Close
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between bg-white dark:bg-[#1a1a1a]">
                    ...
                    <Button
                      className="bg-[#DC021B] hover:bg-[#B30216] text-white px-6 py-2.5 rounded-lg font-bold"
                      onClick={() => setShowFilterSheet(false)}
                    >
                    ...
                    {restaurant?.outlets && Array.isArray(restaurant.outlets) && restaurant.outlets.length > 0 ? (
                      <div className="space-y-2">
                        {restaurant.outlets.map((outlet) => (
                          ...
                          >
                            {outlet?.isNearest && (
                              <div className="flex items-center gap-1.5 mb-2 px-2 py-1 bg-red-50 dark:bg-[#DC021B]/20 rounded-md">
                                <Zap className="h-3.5 w-3.5 text-[#DC021B] dark:text-[#DC021B] fill-[#DC021B] dark:fill-[#DC021B]" />
                                <span className="text-xs font-semibold text-[#DC021B] dark:text-[#DC021B]">
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4">
                    <Button
                      className="w-full bg-[#DC021B] hover:bg-[#B30216] text-white py-3 rounded-lg font-bold"
                      onClick={() => {
                        setShowManageCollections(false)
                      }}
                    >
