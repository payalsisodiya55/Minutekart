...
function DiningCategorySkeleton({ index }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-[64%] rounded-b-[18px] bg-[radial-gradient(circle_at_25%_20%,rgba(220, 2, 27,0.2),transparent_30%),linear-gradient(180deg,#fff5f5_0%,#fff5f5_100%)]">
  ...
  return (
    ...
    >
      <div className="h-full overflow-hidden rounded-2xl bg-white shadow-md ring-1 ring-[#efe2d3]">
        <div className={`relative h-48 overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(220, 2, 27,0.24),transparent_28%),linear-gradient(135deg,#fff5f5_0%,#fff5f5_100%)] sm:h-56 md:h-60 lg:h-64 xl:h-72 ${shimmerClassName}`}>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[40%] bg-gradient-to-r from-[#DC021B] to-transparent/20">
              ...
              <div className="w-full relative">
                <div className="relative bg-white dark:bg-[#1a1a1a] rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 p-1 sm:p-1.5 transition-all duration-300 hover:shadow-xl">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Search className="h-4 w-4 sm:h-4 sm:w-4 text-[#DC021B] flex-shrink-0 ml-2 sm:ml-3" strokeWidth={2.5} />
      ...
      <div className="relative w-full px-3 sm:px-4 md:px-6 lg:px-8 pb-4 sm:pb-6">
        ...
        >
          {diningHeroBanners.length > 0 ? (
            ...
            <div className={`relative h-full w-full bg-[radial-gradient(circle_at_top_left,_rgba(220, 2, 27,0.22),_transparent_35%),linear-gradient(135deg,#fff5f5_0%,#fff9f9_55%,#fff5f5_100%)] ${shimmerClassName}`}>
              <div className="absolute inset-0 bg-[linear-gradient(120deg,transparent_0%,rgba(220, 2, 27,0.05)_35%,transparent_70%)]" />
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 h-[64%] overflow-hidden rounded-b-[18px]">
                    {category.imageUrl ? (
                      ...
                      <div className={`relative h-full w-full bg-[radial-gradient(circle_at_20%_20%,rgba(220, 2, 27,0.22),transparent_35%),linear-gradient(180deg,#fff9f9_0%,#fff5f5_100%)] ${shimmerClassName}`}>
                  ...
                  return (
                    <Button
                      ...
                      className={`h-7 sm:h-8 px-2 sm:px-3 rounded-md flex items-center gap-1.5 whitespace-nowrap flex-shrink-0 transition-all font-medium ${isActive
                        ? 'bg-[#DC021B] text-white border border-[#DC021B] hover:bg-[#B30216]'
                        ...
                        <div className="relative h-48 sm:h-56 md:h-60 lg:h-64 xl:h-72 w-full overflow-hidden rounded-t-2xl flex-shrink-0">
                          ...
                          >
                            {restaurant.image ? (
                              ...
                              <div className={`relative h-full w-full bg-[radial-gradient(circle_at_top_left,rgba(220, 2, 27,0.24),transparent_30%),linear-gradient(135deg,#fff5f5_0%,#fffaf4_55%,#ffe5d0_100%)] ${shimmerClassName}`} />
                            )}
                          </motion.div>
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-[#DC021B] to-transparent" style={{ height: '40%' }}>
                          ...
                          <CardContent className="p-3 sm:p-4 pt-3 sm:pt-4">
                            ...
                            {restaurant.offer && (
                              <div className="flex items-center gap-2 text-sm">
                                <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-[#FFF5F5] px-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-[#DC021B]">
                                  Offer
                                </span>
                        ...
                        <div className="relative h-48 sm:h-56 md:h-60 lg:h-64 xl:h-72 w-full overflow-hidden rounded-t-2xl flex-shrink-0">
                          ...
                          >
                            {restaurant.image ? (
                              ...
                              <div className={`relative h-full w-full bg-[radial-gradient(circle_at_top_left,rgba(220, 2, 27,0.24),transparent_30%),linear-gradient(135deg,#fff5e8_0%,#fffaf4_55%,#ffe5d0_100%)] ${shimmerClassName}`} />
                            )}
                          </motion.div>
          ...
          <div className="absolute bottom-0 left-0 right-0 md:left-1/2 md:right-auto md:-translate-x-1/2 md:max-w-4xl bg-white dark:bg-[#1a1a1a] rounded-t-3xl md:rounded-3xl max-h-[85vh] md:max-h-[90vh] flex flex-col animate-[slideUp_0.3s_ease-out]">
            ...
            <div className="flex items-center justify-between px-4 md:px-6 py-4 md:py-5 border-b dark:border-gray-800">
              ...
              <button
                ...
                className="text-[#DC021B] font-medium text-sm md:text-base"
              >
                Clear all
              </button>
            </div>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 py-4 px-2 text-center relative transition-colors ${isActive ? 'bg-white dark:bg-[#1a1a1a] text-[#DC021B]' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800'
                        }`}
                    >
                      {isActive && (
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#DC021B] rounded-r" />
                      )}
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`px-4 md:px-5 py-3 md:py-4 rounded-xl border text-left transition-colors ${sortBy === option.id
                            ? 'border-[#DC021B] bg-[#FFF5F5] dark:bg-[#DC021B]/20'
                            : 'border-gray-200 dark:border-gray-700 hover:border-[#DC021B]'
                            }`}
                        >
                          <span className={`text-sm md:text-base font-medium ${sortBy === option.id ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>
                            {option.label}
                          </span>
                        </button>
                      ))}
                ...
                {activeFilterTab === 'time' && (
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <Timer className={`h-6 w-6 ${activeFilters.has('delivery-under-30') ? 'text-[#DC021B]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('delivery-under-30') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Under 30 mins</span>
                      </button>
                      <button
                      ...
                      >
                        <Timer className={`h-6 w-6 ${activeFilters.has('delivery-under-45') ? 'text-[#DC021B]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('delivery-under-45') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Under 45 mins</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'rating' && (
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <Star className={`h-6 w-6 ${activeFilters.has('rating-35-plus') ? 'text-[#DC021B] fill-[#DC021B]' : 'text-gray-400 dark:text-gray-500'}`} />
                        <span className={`text-sm font-medium ${activeFilters.has('rating-35-plus') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Rated 3.5+</span>
                      </button>
                      <button
                      ...
                      >
                        <Star className={`h-6 w-6 ${activeFilters.has('rating-4-plus') ? 'text-[#DC021B] fill-[#DC021B]' : 'text-gray-400 dark:text-gray-500'}`} />
                        <span className={`text-sm font-medium ${activeFilters.has('rating-4-plus') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Rated 4.0+</span>
                      </button>
                      <button
                      ...
                      >
                        <Star className={`h-6 w-6 ${activeFilters.has('rating-45-plus') ? 'text-[#DC021B] fill-[#DC021B]' : 'text-gray-400 dark:text-gray-500'}`} />
                        <span className={`text-sm font-medium ${activeFilters.has('rating-45-plus') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Rated 4.5+</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'distance' && (
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <MapPin className={`h-6 w-6 ${activeFilters.has('distance-under-1km') ? 'text-[#DC021B]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('distance-under-1km') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Under 1 km</span>
                      </button>
                      <button
                      ...
                      >
                        <MapPin className={`h-6 w-6 ${activeFilters.has('distance-under-2km') ? 'text-[#DC021B]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('distance-under-2km') ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>Under 2 km</span>
                      </button>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['Continental', 'Italian', 'Asian', 'Indian', 'Chinese', 'American', 'Seafood', 'Cafe'].map((cuisine) => (
                        ...
                        >
                          <span className={`text-sm font-medium ${selectedCuisine === cuisine ? 'text-[#DC021B]' : 'text-gray-700 dark:text-gray-300'}`}>
                            {cuisine}
                          </span>
                        </button>
                      ))}
            ...
            <div className="flex items-center gap-4 md:gap-6 px-4 md:px-6 py-4 md:py-5 border-t dark:border-gray-800 bg-white dark:bg-[#1a1a1a]">
              ...
              <button
                ...
                className={`flex-1 py-3 md:py-4 font-semibold rounded-xl transition-colors text-sm md:text-base ${activeFilters.size > 0 || sortBy || selectedCuisine
                  ? 'bg-[#DC021B] text-white hover:bg-[#B30216]'
