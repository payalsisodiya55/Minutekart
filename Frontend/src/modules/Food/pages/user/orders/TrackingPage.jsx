...
const TrackingPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 font-sans overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 bg-[#DC021B] p-4 pt-4 rounded-b-2xl shadow-lg">
        ...
        <div className="text-center text-white">
          ...
          <div className="flex items-center justify-center gap-2 bg-[#B30216] w-fit mx-auto px-4 py-2 rounded-full">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        ...
        <div className="absolute bottom-[50vh] left-4 right-4 z-10 bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          ...
          <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
            <div className="h-full bg-[#DC021B] rounded-full" style={{ width: '60%' }}></div>
          </div>
        </div>
      </div>
