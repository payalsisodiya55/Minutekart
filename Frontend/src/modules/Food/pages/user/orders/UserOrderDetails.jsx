    ...
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 pb-24 font-sans relative">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {source.phone ? (
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-gray-200 dark:border-neutral-700 flex items-center justify-center text-[#DC021B] hover:bg-red-50 dark:hover:bg-neutral-800 shrink-0"
                      >
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm overflow-hidden">
          <div className="p-4 flex justify-between items-center border-b border-gray-100 dark:border-neutral-700">
            ...
            <button
              ...
              className="w-7 h-7 rounded-full bg-red-50 dark:bg-red-900/30 flex items-center justify-center text-[#DC021B] hover:bg-red-100 dark:hover:bg-red-900/50"
            >
          ...
          <div className="p-4 space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              {pricing.deliveryFee === 0 && (
                <span className="text-[#DC021B] text-[10px] font-bold border border-[#DC021B] px-1 rounded ml-1">
                  FREE
                </span>
              )}
              <span className="text-[#DC021B] font-medium uppercase">
          ...
          {savings > 0 && (
            <div className="relative bg-red-50 dark:bg-red-900/20 p-3 pb-4 mt-2">
              ...
              <div className="flex items-center justify-center gap-2 pt-1 text-[#DC021B] font-bold text-sm">
                <span>??</span>
                <span>
      ...
      <div className="fixed bottom-0 w-full bg-white dark:bg-neutral-900 border-t border-gray-200 dark:border-neutral-800 p-4 flex gap-3 z-20">
        <button
          ...
          className="flex-1 bg-[#DC021B] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#B30216] transition-colors"
        >
        ...
        <button
          type="button"
          onClick={handleDownloadSummary}
          className="flex-1 bg-white dark:bg-neutral-900 border border-[#DC021B] text-[#DC021B] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-red-50 dark:hover:bg-neutral-800 transition-colors"
        >
          <Download className="w-4 h-4" />
          Invoice
        </button>
