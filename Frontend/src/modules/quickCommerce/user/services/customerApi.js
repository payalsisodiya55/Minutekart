...
export const customerApi = {
  ...
  getOrders: (params, options = {}) => quickGetWithDedupe("/quick-commerce/orders", params, options),
  getMyOrders: (params, options = {}) => quickGetWithDedupe("/quick-commerce/orders", params, options),
